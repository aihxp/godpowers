...
v2.5.1 keeps the public slash-command surface coherent and patches the
release-facing runtime after Phase 2 Run A exposed installed-runtime gate
command access and build-gate false-pass defects.
