...
5. Verify each produced artifact on disk, run the configured executable gate
   command from routing metadata before downstream tier transitions, then
   refresh state and checkpoint files.
