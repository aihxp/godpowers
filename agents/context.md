...
- [DECISION] The package name is `godpowers`, and the current repository version is `2.0.3`.
...
- [OPEN QUESTION] Which external messy repository should become the first full host-run adoption case study after `2.0.3`? Owner: maintainer. Due: before the next public release.
