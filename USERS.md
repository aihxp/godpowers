...
Godpowers is at v2.0.2. Stable release.

## Track record

Currently zero recorded production users. Be honest. The 2.0.2 line ships an
executable proof path with release hardening, but real users will reveal which
