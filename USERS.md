...
Godpowers is at v2.2.0. Stable release.

## Track record

Currently zero recorded production users. Be honest. The 2.2.0 line adds
deliverable progress tracking on top of the executable proof path, but real
