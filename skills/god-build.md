...
4. If any verification command fails, do not mark Build complete. Re-enter
   ...
   repair budget.
5. Ensure `.godpowers/build/STATE.md` records the exact verification commands that passed.
6. Run `npx godpowers gate --tier=build --project=.` and do not proceed on non-zero exit.
