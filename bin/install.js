...
function showHelp() {
  ...
  log('  gate                 Run an executable tier gate and emit JSON');
  log('');
  ...
  log('  --tier=<name>        Tier for gate: prd, design, arch, roadmap, stack, repo, build, harden');
...
const COMMAND_RUNNERS = cliDispatch.COMMAND_RUNNERS;
const runCommand = cliDispatch.runCommand;
