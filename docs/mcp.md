...
- [DECISION] MCP mutation tools are out of scope through the 3.13.1 release.
...
```bash
npx -y -p godpowers@3.13.1 -p @godpowers/mcp@3.13.1 godpowers-mcp setup --host=codex --project=.
