...
- [DECISION] MCP mutation tools are out of scope through the 3.8.0 release.
...
```bash
npx -y -p godpowers@3.8.0 -p @godpowers/mcp@3.8.0 godpowers-mcp setup --host=codex --project=.
