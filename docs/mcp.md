...
- [DECISION] MCP mutation tools are out of scope through the 3.0.2 release.
...
```bash
npx -y -p godpowers@3.0.2 -p @godpowers/mcp@3.0.2 godpowers-mcp setup --host=codex --project=.
