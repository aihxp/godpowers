...
- [DECISION] Release result: no npm publish, GitHub tag, or GitHub release was attempted because the `3.0.0` behavior change must go through the protected branch review and merge path first.
