...
Version 3.1.0 adds the evidence producer: `npx godpowers verify "<cmd>"
...
```bash
npx godpowers mcp-info --project=.
npx -y -p godpowers@3.1.0 -p @godpowers/mcp@3.1.0 godpowers-mcp serve --project=.
```
...
```bash
npx -y -p godpowers@3.1.0 -p @godpowers/mcp@3.1.0 godpowers-mcp setup --host=codex --project=. --write
```
