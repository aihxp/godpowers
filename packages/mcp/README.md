...
- [DECISION] Version 3.12.1 exposes eight read-only tools: `status`, `next`, `gate_check`, `lint_artifact`, `trace_requirement`, `work_report`, `route`, and `verification_history`.
- [DECISION] Mutation tools are intentionally absent through the 3.12.1 release.
